...
const MemoryTypes = () => {
      ...
      examples: [
        {
          ...
          content: "Лирическият говорител изразява болката от загубата и носталгията по миналото, представяйки личната си памет, свързана със страданията на арменския народ."
        },
        {
          id: "bot-1",
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box className="MuiBox-root" sx={{ mb: 8, textAlign: 'center' }}>
        <motion.div
