      ...
      sections: [
        {
          ...
          content: "Мнемозина (Mnemosyne) е богинята на паметта в гръцката митология и майка на музите. Името ѝ е в основата на думата 'мнемоника'. Хора като Омир предават епоси устно, relying on memory techniques to recite long narratives."
        },
        {
          subtitle: "Философия и наука",
          icon: <PsychologyIcon sx={{ fontSize: 24 }} />,
          content: "Платон разглежда паметта като припомняне на вечни идеи, които душата е знаела преди раждането. Аристотел прави разлика между памет (спомняне на миналото) и припомняне (активен процес на възстановяване на знание)."
        },
        {
          subtitle: "Техники на паметта",
          icon: <MemoryIcon sx={{ fontSize: 24 }} />,
          content: "Развива се 'изкуството на паметта' (ars memoriae), включващо методи като метода на местата (method of loci), при който информацията се свързва с визуални образи в познати пространства."
        }
      ]
    },
    {
      ...
      sections: [
        {
          ...
          icon: <AutoStoriesIcon sx={{ fontSize: 24 }} />,
          content: "Християнската традиция подчертава важността на паметта за духовния живот, с практики като медитация върху библейски текстове. 'Книгата на паметта' на Мери Карътърс изследва как монасите използват визуални и текстови техники за запаметяване на свещени текстове."
        },
        {
